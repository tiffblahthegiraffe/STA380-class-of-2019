...
mask2$green_rating_type[mask2$green_rating == 1] <- 'green'
mask2$green_rating_type[mask2$green_rating == 0] <- 'not-green'
mask2$green_rating_type = as.factor(mask2$green_rating_type)
```
