...
# Use 'group avg' method to measure proximity
...
summary(factor(cluster1)) # 5 countries in cluster 1; 15 in cluster 2....etc.
...
hier_protein3 = hclust(protein_distance_matrix, method='single')
plot(hier_protein3, cex=0.8) #the 'single' method generate unblance tree
