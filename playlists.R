...
playlists_raw = read.csv(url("https://raw.githubusercontent.com/jgscott/STA380/master/data/playlists.csv"))
...
#items in playlists is a bucket of all artists first user listen to

## Remove duplicates ("de-dupe")
#lapply(): apply funtion to every item.
...
#hml file a standard constrction for saving unstruction data.